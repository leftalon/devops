...
from hlcmdb.models import Game_name_all,IDC_name_all,Server_type_all,Game_type_name
def global_url(request):
    ...
    context = {'all_idc':all_idc,'all_gamename':all_gamename,'all_servertype':all_servertype,'all_gametype':all_gametype}
    return context
